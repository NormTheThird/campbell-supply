<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="AdminOrders.aspx.cs" Inherits="CampbellSupply.Admin.AdminOrders" %>
                    ...
                    <div class="grid-list-products">
                        ...
                        <div id="divOrderDetails" visible="false" runat="server" class="row">
                            <div class="col-xs-12 col-md-12">
                                ...
                                <asp:Button ID="btnHideDetails" CssClass="btn btn-danger btn-md center-block" Text="Hide Details" runat="server" OnClick="btnHideDetails_Click" />
                                <br />
                                <br />
                                <asp:Button ID="btnPrintOrder" CssClass="btn btn-default btn-lg center-block" Text="Print Order" runat="server" OnClick="btnPrintOrder_Click" />
                                ...
                                <section id="orderSummary">
                                    ...
                                    <div class="shipping-address">
                                        ...
                                        <asp:Label ID="lblOrderNumber" Visible="false" runat="server" />
