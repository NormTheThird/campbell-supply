<%@ Page Title="" Language="C#" MasterPageFile="~/Campbells2.Master" AutoEventWireup="true" CodeBehind="Results.aspx.cs" Inherits="CampbellSupply.Results" %>
...
<asp:Content ContentPlaceHolderID="Main" runat="server">
   ...
   <%--               <div class="widget">
                        ...
                        <div class="category-filter">
                            ...
                            <ul>
                                ...
                                <asp:Repeater ID="repCategorys" runat="server">
                                    <ItemTemplate>
                                        <li>
                                            <asp:HyperLink ID="lnkSubCat" CssClass="textCategory" runat="server" Text='<%# Eval("Category")%>'
                                                NavigateUrl='<%# String.Format("~/Category.aspx?department={0}&category={1}", DataBinder.Eval(Container.DataItem, "Department"), DataBinder.Eval(Container.DataItem, "Category"))%>' />
                                        </li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
            ...
            <div class="col-xs-12 col-sm-9 no-margin wide sidebar">
                <asp:Label ID="lblResults" ForeColor="Red" runat="server" Font-Bold="true"/>
                <section id="products">
                                            ...
                                            <ItemTemplate>
                                                <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                                    <div class="product-item">
                                                        <div class="image">
                                                            <!-- IMAGE HYPERLINK WILL LINK TO THE ITEMS DETAIL PAGE -->
                                                            <a href="ItemDetail.aspx?productid=<%# Eval("ProductId")%>">
                                                        ...
                                                        <div class="hover-area">
                                                            <div class="add-cart-button">
                                                                <a href="ItemDetail.aspx?productid=<%# Eval("ProductId")%>" class="le-button">view product</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
